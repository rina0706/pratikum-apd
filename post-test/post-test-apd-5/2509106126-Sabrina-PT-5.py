...
while menu != "5":
    ...
    if menu == "1":
        ...
        dataPotion_Minecraft.append(nama)
        ...
        if len(dataPotion_Minecraft) == 0:
            ...
            if nomor.isdigit():
                nomor_int = int(nomor)
                if nomor_int >= 1 and nomor_int <= len(dataPotion_Minecraft):
                    nama_baru = input("Masukkan nama baru: ")
                    dataPotion_Minecraft[nomor_int-1] = nama_baru
        ...
        if len(dataPotion_Minecraft) == 0:
            ...
            if nomor.isdigit():
                nomor_int = int(nomor)
                if nomor_int >= 1 and nomor_int <= len(dataPotion_Minecraft):
                    dataPotion_Minecraft.pop(nomor_int-1)
